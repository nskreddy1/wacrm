...
built by the **135 migrations** in `supabase/migrations/`.
...
Tables outside `public` are not expanded here: `auth` (23), `cron` (2), `net` (2), `realtime` (2), `storage` (8), `vault` (1), `wacrm_internal` (1). Inspect
