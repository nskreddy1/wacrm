...
// ============================================================
// Bits shared by the direct (fetch-based) provider adapters.
...
// Transcript merging is engine-agnostic — re-exported here so the
// restored adapters keep importing it from './shared'.
