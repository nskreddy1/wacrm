...
//
// Both engines (direct fetch adapters and LangChain) and their
// callers/tests branch on the exact same error codes: invalid_key,
// rate_limited, timeout, network_error, provider_error,
// missing_base_url, unsupported_provider, empty_response — so the
// mapping lives here, outside either engine.
// ============================================================
...
/**
 * Map any provider SDK / LangChain / network failure to our typed
