...
export const metadata: Metadata = {
  ...
  description:
    'Enterprise CRM for WhatsApp, SMS, and email — conversations, contacts, pipelines, campaigns, and appointments.',
  robots: {
    index: false,
    follow: false,
  },
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      className={`${inter.variable} ${instrumentSerif.variable} bg-background h-full antialiased`}
