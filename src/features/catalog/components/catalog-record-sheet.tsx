 ...
 */
export function CatalogRecordSheet({
  open,
  item,
  onOpenChange,
  onSaved,
...
function CatalogRecordSheetForm({
  item,
  onOpenChange,
  onSaved,
}: {
      ...
      >
        <RecordSection id="catalog-information" title="Item Information">
          ...
          <RecordField
            ...
            error={!priceValid && error ? error : undefined}
          >
          ...
          <RecordSection id="catalog-additional" title="Additional Information">
            {layout?.custom.map((field) => (
              <RecordField
                key={field.id}
                label={field.label}
                htmlFor={`catalog-custom-${field.id}`}
              >
                <Input
