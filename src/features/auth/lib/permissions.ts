    ...
    permissions: [
      {
        slug: 'contacts:read',
        label: 'View contacts',
        description: 'See contacts and their timelines',
      },
      {
        slug: 'contacts:write',
        label: 'Edit contacts',
      ...
      },
      {
        ...
        description: 'Remove contacts permanently',
      },
      {
        slug: 'companies:read',
      ...
      },
      {
        ...
        description: 'Remove companies permanently',
      },
      {
        slug: 'deals:read',
        label: 'View deals',
        description: 'See pipelines and deals',
      },
      {
        slug: 'deals:write',
        label: 'Edit deals',
        description: 'Create, update and move deals',
      },
      {
        slug: 'deals:delete',
        label: 'Delete deals',
      ...
      },
      {
        ...
        description: 'See tasks and appointments',
      },
      {
        slug: 'activities:write',
        label: 'Edit activities',
        description: 'Create and update tasks and appointments',
      },
      {
        slug: 'activities:delete',
        label: 'Delete activities',
        description: 'Remove activities permanently',
      },
    ],
  },
  {
    ...
    permissions: [
      {
        slug: 'messages:send',
        label: 'Send messages',
        description: 'Reply to conversations in the inbox',
      },
      {
        slug: 'broadcasts:send',
        label: 'Send broadcasts',
        description: 'Create and send WhatsApp broadcast campaigns',
      },
      {
        slug: 'sms:send',
        label: 'Send SMS',
        description: 'Send SMS messages and campaigns',
      },
      {
      ...
      },
      {
        ...
        label: 'Manage quick replies',
        description: 'Create and edit saved replies',
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        description: 'Configure AI auto-reply and agents',
      },
    ],
  },
  {
    ...
    permissions: [
      {
        slug: 'data:import',
        label: 'Import data',
        description: 'Import contacts and records from files',
      },
      {
        slug: 'data:export',
        label: 'Export data',
        description: 'Export records to files',
      },
    ],
  },
  {
    ...
    permissions: [
      {
        slug: 'members:manage',
        label: 'Manage users',
        description: 'Invite, deactivate and assign profiles to users',
      },
      {
        slug: 'settings:manage',
        label: 'Manage settings',
        description: 'Edit workspace-wide settings',
      },
      {
        slug: 'channels:manage',
        label: 'Manage channels',
        description: 'Configure WhatsApp, SMS and email channels',
      },
      {
...
export const ALL_PERMISSIONS: readonly PermissionSlug[] =
  PERMISSION_GROUPS.flatMap((g) => g.permissions.map((p) => p.slug));

/** Slugs seeded into the system "Administrator" profile (all of them). */
export const ADMINISTRATOR_PERMISSIONS: readonly PermissionSlug[] =
  ALL_PERMISSIONS;

/** Slugs seeded into the system "Standard" profile (no administration). */
export const STANDARD_PERMISSIONS: readonly PermissionSlug[] =
...
export function deriveCapabilities(
  ...
  const has = (slug: PermissionSlug) =>
    hasPermission(permissions, slug, isOwner);
  const canWrite =
    isOwner || WRITE_SLUGS.some((slug) => permissions.includes(slug));
  return {
