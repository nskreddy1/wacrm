    ...
    <div className="flex h-full flex-col gap-4">
            ...
            <div key={stage.name} className="flex flex-col gap-1">
              <div className="flex items-baseline justify-between gap-2 text-xs">
                ...
                >
                  ...
                  {moneyFormatter.format(stage.value)}
                </span>
              </div>
              <AnimatedBar
                percent={pct}
      ...
      <div className="border-border grid grid-cols-2 gap-3 border-t pt-4">
        <div className="flex items-center gap-2.5">
          <div className="bg-positive/10 text-positive flex size-8 items-center justify-center rounded-lg">
          ...
          <div>
            ...
            />
            <p className="text-muted-foreground text-[11px]">{`Won · ${wonCount30d} deals (30d)`}</p>
          </div>
        </div>
        <div className="flex items-center gap-2.5">
