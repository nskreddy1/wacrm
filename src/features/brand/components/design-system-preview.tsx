...
const COPY_RULES = [
  ...
  {
    before:
      'Posts to the #Alerts channel in this workspace. Available without setup.',
    ...
    <main className="bg-background text-foreground min-h-screen">
      <div className="mx-auto max-w-5xl px-5 py-12 md:px-8 md:py-16">
        <div className="mb-2 flex items-center gap-2">
          <span className="bg-primary-soft text-primary rounded px-1.5 py-0.5 font-mono text-[10px] tracking-wide uppercase">
            static spec
          </span>
        ...
        >
          ...
          <div className="border-border bg-card mt-6 rounded-lg border p-4">
            <p className="text-foreground mb-3 text-sm font-semibold">Rules</p>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
            {TOKENS.map((c) => (
              <div key={c.name} className="flex flex-col gap-2">
                <div
                  className={cn('border-border h-16 rounded-lg border', c.cls)}
                />
                <div>
              ...
              <tbody>
                {COPY_RULES.map((r) => (
                  ...
                  >
                    ...
                    <td className="text-muted-foreground decoration-destructive/50 px-3 py-2 line-through">
                      {r.before}
                    </td>
