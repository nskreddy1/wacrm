...
export function ContactWorkspace() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] flex-col bg-background">
      ...
      <ContactFilterBuilder open={filterOpen} fields={orderedFields} value={filters} onOpenChange={setFilterOpen} onApply={(value) => { setFilters(value); setPage(0) }} onClear={() => { setFilters(emptyFilterGroup()); setPage(0) }} />
