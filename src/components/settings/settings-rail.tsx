...
export function SettingsRail({
  ...
  return (
    <nav
      ...
      className={cn(
        'flex max-h-28 flex-wrap gap-1 overflow-y-auto pb-2 sm:max-h-none sm:[scrollbar-width:none] sm:flex-nowrap sm:overflow-x-auto sm:overflow-y-visible sm:[&::-webkit-scrollbar]:hidden',
