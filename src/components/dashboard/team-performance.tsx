      ...
      <div className="flex flex-1 flex-col gap-3.5">
        {team.map((member) => (
          <div key={member.userId} className="flex items-center gap-3">
            <div
              className="flex size-8 shrink-0 items-center justify-center rounded-full bg-primary-soft text-[11px] font-bold text-primary"
              aria-hidden="true"
            >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-baseline justify-between gap-2">
                ...
                <p className="shrink-0 text-[11px] text-muted-foreground" style={{ fontVariantNumeric: "tabular-nums" }}>
